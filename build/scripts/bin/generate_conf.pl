...
my $DEBUG = 0;
my $HELP    = 0;
my @PROTOS_NAME = qw(ModuleMem AllocateMem set_var_info_bfm init_var_bfm INCLUDE BFM_var_list BFM0D_Output_Ecology namelist);
my @PROTOS_EXT  = qw(F90       F90         F90              F90          h       h           F90  passivetrc );
