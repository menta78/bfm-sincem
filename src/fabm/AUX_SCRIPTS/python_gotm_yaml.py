...
for i,wl in enumerate(wavelenghts_list):
    ...
    string4="         file: Ed.txt               # path to file with time series [default=]"
    string5="         column: " + str(c) + "                     # index of column to read from [default=1]"
    print(string1)
    print(string2)
    print(string3)
    print(string4)
...
for i,wl in enumerate(wavelenghts_list):
    ...
    string2="         method: file                  # method [constant, file=from file; default=constant]"
    string3="         constant_value: 0.0         # value to use throughout the simulation [m/s; default=0.0]"
    string4="         file: Es.txt               # path to file with time series [default=]"
    string5="         column: " + str(c) + "                     # index of column to read from [default=1]"
    print(string1)
    print(string2)
    print(string3)
